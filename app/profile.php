...
$today = date("Y-m-d");
$eventsql = "select * from events where (performer_id = " . $id . " OR id = " . $id . ") AND event_date BETWEEN DATE_SUB('" . $today . "', INTERVAL 30 DAY) AND DATE_ADD('" . $today . "', INTERVAL 30 DAY) ORDER BY event_date ASC;";
